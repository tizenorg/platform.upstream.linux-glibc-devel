...
/* Reads (or writes) a byte/uword/udword from the specified mode
   register. */
#define IO_RD(reg) (*(__volatile__ u32*)(reg))
#define IO_RD_B(reg) (*(__volatile__ u8*)(reg))
#define IO_RD_W(reg) (*(__volatile__ u16*)(reg))
#define IO_RD_D(reg) (*(__volatile__ u32*)(reg))
...
# define  IO_TYPECAST_UDWORD  (__volatile__ u32*)
# define  IO_TYPECAST_RO_UDWORD  (const __volatile__ u32*)
# define  IO_TYPECAST_UWORD  (__volatile__ u16*)
# define  IO_TYPECAST_RO_UWORD  (const __volatile__ u16*)
# define  IO_TYPECAST_BYTE  (__volatile__ u8*)
# define  IO_TYPECAST_RO_BYTE  (const __volatile__ u8*)
#else
